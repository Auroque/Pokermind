...
//Adicionando as imagens destacadas NO POST-------------------------------------------
...
if ( function_exists('register_sidebar') )     //se existir um widget será executado o array abaixo.
        register_sidebar(array(
		'name' => __( 'Destaque' ),
		'id' => '1-widget-area',
		'description' => __( 'Imagem Início' ),
