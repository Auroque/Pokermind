...
<?php 
	...
	<div class="section single">
		<div class="container">
			...
			<h2>Ranking Open League 50k</h2>
                           <div id="tabela1" class="inner" style="display:block;padding-top:0px;margin-top:0px;">
    				...
    				<div class="widget_text01">
    					<h3 class="no-padding">REDES SOCIAIS</h3>
    						<div class="row">
    							...
    							<a href="#" target="_blank">
    								<div class="col-md-2 icon-height ico-04">
    									<i class="fa fa-whatsapp" aria-hidden="true"></i>
    								</div>
    								<div class="col-md-10 icon-height text-04">
    									<p>WhatsApp</p>
    								</div>
    							</a>
    							<a href="#" target="_blank">
